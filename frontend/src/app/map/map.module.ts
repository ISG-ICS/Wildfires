...
import {TabGroupBasicExample} from './tab/tab.component';
...
@NgModule({
    declarations: [HeatmapComponent, SidebarComponent, TimeSeriesComponent, TemperatureRangeSliderComponent, SearchComponent, SearchComponent, TabGroupBasicExample],
    exports: [
        HeatmapComponent,
        SidebarComponent,
        TimeSeriesComponent,
