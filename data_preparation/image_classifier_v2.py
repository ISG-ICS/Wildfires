...
def label_pic(url, label_list):
    ...
    predictor.setModelPath("models/model_ex-052_acc-0.816576.h5")
    predictor.setJsonPath("model_class_v2.js")
    predictor.loadModel(num_objects=8)
    ...
    try:
        ...
        predictions, probabilities = predictor.predictImage(download_name, result_count=20)
...
if __name__ == '__main__':
    ...
    while True:
        ...
        print("wildfire_v2: ", results[0])
        upload_features(id, features_database, results)
