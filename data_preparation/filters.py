...
with open("../data/tweets/wildfire.json", 'rb') as F:
...
# data_TimeFilterstered = RetweetFilter(data_TimeFiltered)
data_BotFiltered = BotFilter(data_LocationFiltered)
print(len(data_BotFiltered))
with open("./test.json", 'w') as file:
    json.dump(data_BotFiltered, file )
